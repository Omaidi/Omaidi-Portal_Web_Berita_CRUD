...
@section('title', 'Buat Password Baru - Portal Berita')
                ...
                <div class="rounded-md shadow-sm space-y-4">
                    <div>
                        ...
                        <input id="email-address" name="email" type="email" autocomplete="email" required
                            ...
                            placeholder="user@example.com" value="{{ $email ?? old('email') }}">
                    </div>
                    <div>
                ...
                <div>
                    <button type="submit"
                        ...
                        <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                            <span
                                class="material-symbols-outlined text-primary-dark group-hover:text-white transition-colors">save</span>
                        </span>
                        Reset Password
                    </button>
                </div>
