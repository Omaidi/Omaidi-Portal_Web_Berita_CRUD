...
@section('content')
    <header
        ...
        <div>
            <h2 class="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">Edit Pengguna</h2>
            <p class="text-slate-500 dark:text-slate-400 font-sans text-sm">Perbarui data pengguna.</p>
        </div>
    ...
    <div class="flex-1 overflow-auto px-8 pb-8">
        <div
            ...
            <form action="{{ route('admin.users.update', $user->id) }}" method="POST" class="flex flex-col gap-6">
                ...
                <div class="flex flex-col gap-2">
                    <label class="text-sm font-semibold text-slate-700 dark:text-slate-300 font-sans">Password
                        (Opsional)</label>
                ...
                <div class="flex flex-col gap-2">
                    <label class="text-sm font-semibold text-slate-700 dark:text-slate-300 font-sans">Konfirmasi
                        Password</label>
                    <input type="password" name="password_confirmation" placeholder="Kosongkan jika tidak ingin mengubah"
                        class="font-sans px-4 py-2.5 rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-primary focus:border-primary">
                </div>
