...
@section('content')
    <header
        ...
        <div>
            <h2 class="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">Tambah Kategori</h2>
            <p class="text-slate-500 dark:text-slate-400 font-sans text-sm">Buat kategori baru.</p>
        </div>
